...
<body>
      ...
      <section id="dashboard" class="section active">
        ...
        <div class="grid">
          ...
          <div class="card">
            ...
            <p class="subtext">
              Quick read of today’s environment before you turn any strategy ON.
            </p>
            <div class="meta-row">
              <span>Trend bias: Trend ☐ / Range ☐ / Choppy ☐</span>
              <span>Vol: High ☐ / Normal ☐ / Low ☐</span>
              <span>News: Major ☐ / None ☐</span>
            </div>
            <textarea
              class="note-input"
          ...
          <div class="card">
            ...
            <div class="checklist">
              ...
              <label class="checklist-item">
                ...
                <span>
                  Mental clarity ≥ 4/10, no extreme manic/depressed state.
                </span>
              </label>
              <label class="checklist-item">
            ...
            <div class="badge-row">
              ...
              <span class="badge badge-warning"
                >If any box is OFF → reduce or skip</span
              >
            </div>
          </div>
      ...
      <section id="daily" class="section">
        ...
        <div class="grid">
          ...
          <div class="card">
            ...
            <div class="checklist">
              <label class="checklist-item">
                ...
                <span>Sleep score logged (0–10).</span>
              </label>
              <label class="checklist-item">
                <input type="checkbox" id="pm_bipolar_logged" />
                <span>Mental / bipolar score logged (0–10).</span>
              </label>
              <label class="checklist-item">
          ...
          <div class="card">
            ...
            <div class="checklist">
              ...
              <label class="checklist-item">
                ...
                <span>Check if we’re at major extremes (weekly/monthly high/low).</span>
              </label>
              <label class="checklist-item">
          ...
          <div class="card">
            ...
            <p class="subtext">
              Run this before every entry. If any answer is “no”, skip the trade.
            </p>
            <div class="checklist">
              <label class="checklist-item">
              ...
              <label class="checklist-item">
                ...
                <span>Contract size within your rules (no “hero” size).</span>
              </label>
              <label class="checklist-item">
                <input type="checkbox" id="trade_future_self_question" />
                <span>
                  Future-self check: “If I was already a Viking / up 5k, would I take this trade?”
                </span>
              </label>
            </div>
            <textarea
      ...
      <section id="strategies" class="section">
        ...
        <div class="grid">
          ...
          <div class="card">
            ...
            <ul class="checklist">
              <li class="checklist-item" style="list-style: none;">
                <span>• Price is below VWAP.</span>
              </li>
              <li class="checklist-item" style="list-style: none;">
                <span>• 3 consecutive bars making lower lows (flush pattern).</span>
              </li>
              <li class="checklist-item" style="list-style: none;">
                <span>• Volume/footprint confirms aggression (no sleepy tape).</span>
              </li>
            </ul>
            ...
            <ul class="checklist">
              <li class="checklist-item" style="list-style: none;">
                <span>• Price is above VWAP.</span>
              </li>
              <li class="checklist-item" style="list-style: none;">
                <span>• 3 consecutive bars making higher highs (pop pattern).</span>
              </li>
              <li class="checklist-item" style="list-style: none;">
                <span>• Volume confirms buyers in control.</span>
              </li>
            </ul>
            ...
            <div class="badge-row">
              ...
              <span class="badge badge-warning">Big news within 5–10 minutes</span>
            </div>
          </div>
          ...
          <div class="card">
            ...
            <ul class="checklist">
              <li class="checklist-item" style="list-style: none;">
                <span>• Identify upper/lower VWAP bands (e.g. stdev).</span>
              </li>
              <li class="checklist-item" style="list-style: none;">
                <span>• Look for exhaustion at bands (wicks, failed pushes, footprint absorption).</span>
              </li>
              <li class="checklist-item" style="list-style: none;">
                <span>• Target is reversion toward VWAP, with tight risk.</span>
              </li>
            </ul>
            <h3>Best Environment</h3>
            <div class="badge-row">
          ...
          <div class="card">
            ...
            <ul class="checklist">
              <li class="checklist-item" style="list-style: none;">
                <span>• Strong gap in one direction.</span>
              </li>
              <li class="checklist-item" style="list-style: none;">
                <span>• First 30–60 minutes show clean continuation, not whipsaw.</span>
              </li>
              <li class="checklist-item" style="list-style: none;">
                <span>• ES/NQ and breadth aligned.</span>
              </li>
            </ul>
            <h3>Best Environment</h3>
            <div class="badge-row">
        ...
        <div class="grid">
          ...
          <div class="card">
            ...
            <textarea
              ...
              placeholder="List 2–3 things you did well today..."
            ></textarea>
            <h3>Areas to Improve</h3>
            <textarea
              class="note-input"
              data-note-id="eod_improve"
              placeholder="1–2 specific changes for tomorrow..."
            ></textarea>
  ...
  <script>
    ...
    // Reset daily checkboxes (but keep notes)
    document.getElementById("resetDayBtn").addEventListener("click", () => {
      if (!confirm("Reset today’s checkboxes? Notes will be kept.")) return;
